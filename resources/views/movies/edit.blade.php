            ...
            <div class="col-md-8">
                <div class="card border-secondary">
                    ...
                    <div class="card-body" style="float: right; text-align: right;">
                        ...
                        @endif
                        <form method="post" action="/workshops/update/{{$workshop->id}}">
                            @csrf

                            <div class="form-group row">
                                <div class="col-md-8">
                                    <input value="{{$workshop->subject_fa}}" style="text-align: right" id="subject_fa" type="text" class="form-control{{ $errors->has('subject_fa') ? ' is-invalid' : '' }}" name="subject_fa"  required autofocus>
                            ...
                            <div class="form-group row">
                                <div class="col-md-8">
                                    <input value="{{$workshop->subject_en}}" style="text-align: right" id="subject_en" type="text" class="form-control{{ $errors->has('subject_en') ? ' is-invalid' : '' }}" name="subject_en"  required autofocus>
                            ...
                            <div class="form-group row">
                                <div class="col-md-8">
                                    <input value="{{$workshop->category_fa}}" style="text-align: right" id="category_fa" type="text" class="form-control{{ $errors->has('category_fa') ? ' is-invalid' : '' }}" name="category_fa"  required autofocus>
                            ...
                            <div class="form-group row">
                                <div class="col-md-8">
                                    <input value="{{$workshop->category_en}}" style="text-align: right" id="category_en" type="text" class="form-control{{ $errors->has('category_en') ? ' is-invalid' : '' }}" name="category_en"  required autofocus>
                            ...
                            <div class="form-group row">
                                <div class="col-md-8">
                                    <input value="{{$workshop->teacher_name_fa}}" style="text-align: right" id="teacher_name_fa" type="text" class="form-control{{ $errors->has('teacher_name_fa') ? ' is-invalid' : '' }}" name="teacher_name_fa"  required autofocus>
                            ...
                            <div class="form-group row">
                                <div class="col-md-8">
                                    <input value="{{$workshop->teacher_name_en}}" style="text-align: right" id="teacher_name_en" type="text" class="form-control{{ $errors->has('teacher_name_en') ? ' is-invalid' : '' }}" name="teacher_name_en"  required autofocus>
                            ...
                            <div class="form-group row">
                                <div class="col-md-8">
{{--                                    <input value="{{$workshop->teacher_info_fa}}" style="text-align: right" id="teacher_info_fa" type="text" class="form-control{{ $errors->has('teacher_info_fa') ? ' is-invalid' : '' }}" name="teacher_info_fa"  required autofocus>--}}
                                    <textarea name="teacher_info_fa" id="" cols="30" rows="5" class="form-control">{{$workshop->teacher_info_fa}}</textarea>
                            ...
                            <div class="form-group row">
                                <div class="col-md-8">
{{--                                    <input value="{{$workshop->teacher_info_en}}" style="text-align: right" id="teacher_info_en" type="text" class="form-control{{ $errors->has('teacher_info_en') ? ' is-invalid' : '' }}" name="teacher_info_en"  required autofocus>--}}
                                    <textarea name="teacher_info_en" id="" cols="30" rows="5" class="form-control">{{$workshop->teacher_info_en}}</textarea>
                            ...
                            <div class="form-group row">
                                <div class="col-md-8">
                                    <input value="{{$workshop->link_hls}}" style="text-align: right" id="link_hls" type="text" class="form-control{{ $errors->has('link_hls') ? ' is-invalid' : '' }}" name="link_hls"  required autofocus>
                            ...
                            <div class="form-group row">
                                <div class="col-md-8">
                                    <input value="{{$workshop->link_dash}}" style="text-align: right" id="link_dash" type="text" class="form-control{{ $errors->has('link_dash') ? ' is-invalid' : '' }}" name="link_dash"  required autofocus>
                            ...
                            <div class="form-group row">
                                <div class="col-md-8">
{{--                                    <input value="{{$workshop->text_fa}}" style="text-align: right" id="text_fa" type="text" class="form-control{{ $errors->has('text_fa') ? ' is-invalid' : '' }}" name="text_fa"  required autofocus>--}}
                                    <textarea name="text_fa" id="" cols="30" rows="5" class="form-control">{{$workshop->text_fa}}</textarea>
                            ...
                            <div class="form-group row">
                                <div class="col-md-8">
{{--                                    <input value="{{$workshop->text_en}}" style="text-align: right" id="text_en" type="text" class="form-control{{ $errors->has('text_en') ? ' is-invalid' : '' }}" name="text_en"  required autofocus>--}}
                                    <textarea name="text_en" id="" cols="30" rows="5" class="form-control">{{$workshop->text_en}}</textarea>
                            ...
                            <div class="form-group row">
                                <div class="col-md-8">
                                    <input value="{{$workshop->country_fa}}" style="text-align: right" id="country_fa" type="text" class="form-control{{ $errors->has('country_fa') ? ' is-invalid' : '' }}" name="country_fa"  required autofocus>
                            ...
                            <div class="form-group row">
                                <div class="col-md-8">
                                    <input value="{{$workshop->country_en}}" style="text-align: right" id="country_en" type="text" class="form-control{{ $errors->has('country_en') ? ' is-invalid' : '' }}" name="country_en"  required autofocus>
                            ...
                            <div class="form-group row">
                                <div class="col-md-8">
                                    <input value="{{$workshop->festival_number}}" style="text-align: right" id="festival_number" type="text" class="form-control{{ $errors->has('festival_number') ? ' is-invalid' : '' }}" name="festival_number"  required autofocus>
