                    ...
                    <div class="card-body" style="float: right; text-align: right;">
                        ...
                        <form method="post" action="/movies/update/{{$movie->id}}">
                            ...
                            <div class="form-group row">
                                <div class="col-md-8">
                                    <input value="{{$movie->name_fa}}" style="text-align: right" id="name_fa" type="text" class="form-control{{ $errors->has('name_fa') ? ' is-invalid' : '' }}" name="name_fa"  required autofocus>
                            ...
                            <div class="form-group row">
                                <div class="col-md-8">
                                    <input value="{{$movie->name_en}}" style="text-align: right" id="name_en" type="text" class="form-control{{ $errors->has('name_en') ? ' is-invalid' : '' }}" name="name_en"  required autofocus>
                            ...
                            <div class="form-group row">
                                <div class="col-md-8">
                                    <input value="{{$movie->director_name_fa}}" style="text-align: right" id="director_name_fa" type="text" class="form-control{{ $errors->has('director_name_fa') ? ' is-invalid' : '' }}" name="director_name_fa"  required autofocus>
                            ...
                            <div class="form-group row">
                                <div class="col-md-8">
                                    <input value="{{$movie->director_name_en}}" style="text-align: right" id="director_name_en" type="text" class="form-control{{ $errors->has('director_name_en') ? ' is-invalid' : '' }}" name="director_name_en"  required autofocus>
                            ...
                            <div class="form-group row">
                                <div class="col-md-8">
                                    <input value="{{$movie->producer_name_fa}}" style="text-align: right" id="producer_name_fa" type="text" class="form-control{{ $errors->has('producer_name_fa') ? ' is-invalid' : '' }}" name="producer_name_fa"  required autofocus>
                            ...
                            <div class="form-group row">
                                <div class="col-md-8">
                                    <input value="{{$movie->producer_name_en}}" style="text-align: right" id="producer_name_en" type="text" class="form-control{{ $errors->has('producer_name_en') ? ' is-invalid' : '' }}" name="producer_name_en"  required autofocus>
                            ...
                            <div class="form-group row">
                                <div class="col-md-8">
                                    <input value="{{$movie->length}}" style="text-align: right" id="length" type="text" class="form-control{{ $errors->has('length') ? ' is-invalid' : '' }}" name="length"  required autofocus>
                            ...
                            <div class="form-group row">
                                <div class="col-md-8">
                                    <input value="{{$movie->format}}" style="text-align: right" id="format" type="text" class="form-control{{ $errors->has('format') ? ' is-invalid' : '' }}" name="format"  required autofocus>
                            ...
                            <div class="form-group row">
                                <div class="col-md-8">
                                    ...
                                    <select name="type_fa" id="type_fa" class="form-control">
                                        <option @if ($movie->type_fa =='سینمایی بلند') {{__('selected')}} @endif value="سینمایی بلند">سینمایی بلند</option>
                                        <option @if ($movie->type_fa =='مستند کوتاه') {{__('selected')}} @endif value="مستند کوتاه">مستند کوتاه</option>
                                        <option @if ($movie->type_fa =='مستند نیمه بلند') {{__('selected')}} @endif value="مستند نیمه بلند">مستند نیمه بلند</option>
                                        <option @if ($movie->type_fa =='مستند بلند') {{__('selected')}} @endif value="مستند بلند">مستند بلند</option>
                                        <option @if ($movie->type_fa =='فیلم های کوتاه') {{__('selected')}} @endif value="فیلم های کوتاه">فیلم های کوتاه</option>
                                    </select>
                            ...
                            <div class="form-group row">
                                <div class="col-md-8">
                                    <input value="{{$movie->type_en}}" style="text-align: right" id="type_en" type="text" class="form-control{{ $errors->has('type_en') ? ' is-invalid' : '' }}" name="type_en"  required autofocus>
                            ...
                            <div class="form-group row">
                                <div class="col-md-8">
                                    <input value="{{$movie->genre_fa}}" style="text-align: right" id="genre_fa" type="text" class="form-control{{ $errors->has('genre_fa') ? ' is-invalid' : '' }}" name="genre_fa"  required autofocus>
                            ...
                            <div class="form-group row">
                                <div class="col-md-8">
                                    <input value="{{$movie->genre_en}}" style="text-align: right" id="genre_en" type="text" class="form-control{{ $errors->has('genre_en') ? ' is-invalid' : '' }}" name="genre_en"  required autofocus>
                            ...
                            <div class="form-group row">
                                <div class="col-md-8">
                                    <input value="{{$movie->product_year_fa}}" style="text-align: right" id="product_year_fa" type="text" class="form-control{{ $errors->has('product_year_fa') ? ' is-invalid' : '' }}" name="product_year_fa"  required autofocus>
                            ...
                            <div class="form-group row">
                                <div class="col-md-8">
                                    <input value="{{$movie->product_year_en}}" style="text-align: right" id="product_year_en" type="text" class="form-control{{ $errors->has('product_year_en') ? ' is-invalid' : '' }}" name="product_year_en"  required autofocus>
                            ...
                            <div class="form-group row">
                                <div class="col-md-8">
                                    ...
                                    <textarea name="summary_fa" id="summary_fa" cols="30" rows="5" class="form-control">{{$movie->summary_fa}}</textarea>
                            ...
                            <div class="form-group row">
                                <div class="col-md-8">
                                    ...
                                    <textarea name="summary_en" id="summary_en" cols="30" rows="5" class="form-control">{{$movie->summary_en}}</textarea>
                            ...
                            <div class="form-group row">
                                <div class="col-md-8">
                                    <input value="{{$movie->country_fa}}" style="text-align: right" id="country_fa" type="text" class="form-control{{ $errors->has('country_fa') ? ' is-invalid' : '' }}" name="country_fa"  required autofocus>
                            ...
                            <div class="form-group row">
                                <div class="col-md-8">
                                    <input value="{{$movie->country_en}}" style="text-align: right" id="country_en" type="text" class="form-control{{ $errors->has('country_en') ? ' is-invalid' : '' }}" name="country_en"  required autofocus>
                            ...
                            <div class="form-group row">
                                <div class="col-md-8">
                                    <input value="{{$movie->show_subject_fa}}" style="text-align: right" id="show_subject_fa" type="text" class="form-control{{ $errors->has('show_subject_fa') ? ' is-invalid' : '' }}" name="show_subject_fa"  required autofocus>
                            ...
                            <div class="form-group row">
                                <div class="col-md-8">
                                    <input value="{{$movie->show_subject_en}}" style="text-align: right" id="show_subject_en" type="text" class="form-control{{ $errors->has('show_subject_en') ? ' is-invalid' : '' }}" name="show_subject_en"  required autofocus>
                            ...
                            <div class="form-group row">
                                <div class="col-md-8">
                                    <input value="{{$movie->show_date_fa}}" style="text-align: right" id="show_date_fa" type="text" class="form-control{{ $errors->has('show_date_fa') ? ' is-invalid' : '' }}" name="show_date_fa"  required autofocus>
                            ...
                            <div class="form-group row">
                                <div class="col-md-8">
                                    <input value="{{$movie->show_date_en}}" style="text-align: right" id="show_date_en" type="datetime-local" class="form-control{{ $errors->has('show_date_en') ? ' is-invalid' : '' }}" name="show_date_en"  required autofocus>
                            ...
                            <div class="form-group row">
                                <div class="col-md-8">
                                    ...
                                    <textarea name="awards_fa" id="awards_fa" cols="30" rows="5" class="form-control">{{$movie->awards_fa}}</textarea>
                            ...
                            <div class="form-group row">
                                <div class="col-md-8">
                                    ...
                                    <textarea name="awards_en" id="awards_en" cols="30" rows="5" class="form-control">{{$movie->awards_en}}</textarea>
                            ...
                            <div class="form-group row">
                                <div class="col-md-8">
                                    <input value="{{$movie->trailer_link_hls}}" style="text-align: right" id="trailer_link_hls" type="text" class="form-control{{ $errors->has('trailer_link_hls') ? ' is-invalid' : '' }}" name="trailer_link_hls"  required autofocus>
                            ...
                            <div class="form-group row">
                                <div class="col-md-8">
                                    <input value="{{$movie->trailer_link_dash}}" style="text-align: right" id="trailer_link_dash" type="text" class="form-control{{ $errors->has('trailer_link_dash') ? ' is-invalid' : '' }}" name="trailer_link_dash"  required autofocus>
                            ...
                            <div class="form-group row">
                                <div class="col-md-8">
                                    <input value="{{$movie->festival_number}}" style="text-align: right" id="festival_number" type="text" class="form-control{{ $errors->has('festival_number') ? ' is-invalid' : '' }}" name="festival_number"  required autofocus>
